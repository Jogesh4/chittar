    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12" data-aos="fade-up">
         <div class="m-2"><a href="/" title="Home" class="home-bc">Home</a> <span aria-hidden="true">›</span><span style=" text-transform: uppercase; font-size: 14px; ">{{ request()->name }}</span> </div>
        </div>
            ...
            <div class="row g-2">
                ...
                <div class="col-md-4">
                    <div class="product py-4"> <span class="off bg-success">-25% OFF</span>
                        <div class="text-center"> <img src="images/4.jpg" width="200"> </div>
                        <div class="about text-center">
                            <h5>Jutti</h5> <span>$199</span>
                        </div>
                        <div class="cart-button mt-3 px-2 d-flex justify-content-between align-items-center"> <button class="btn-pink text-uppercase">Add to cart</button>
